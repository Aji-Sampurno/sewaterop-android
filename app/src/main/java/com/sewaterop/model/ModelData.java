...
public class ModelData {String id_pesanan, nama_pemesan, tgl_mulai, waktu_mulai, tgl_selesai, waktu_selesai, status_pembayaran;

    public ModelData(){}

    public ModelData(String id_pesanan, String nama_pemesan, String tgl_mulai, String waktu_mulai, String tgl_selesai, String waktu_selesai, String status_pembayaran) {
